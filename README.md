...
Ось повний текст для вашого **`README.md`**, який містить всі необхідні
пояснення щодо технологій, структури та робочого процесу.
...
**Accordion Library** | Реалізація секцій Details, Shipping та Returns у
модальному вікні книги | | | | (згідно з ТЗ). | | **Сповіщення**| **iziToast** |
Елегантні спливаючі повідомлення для API-помилок та успішного додавання | | | |
до кошика/реєстрації. |
